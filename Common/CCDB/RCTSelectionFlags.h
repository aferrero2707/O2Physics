...
class RCTFlagsChecker : public o2::utils::EnumFlags<RCTSelectionFlags>
{
 public:
  ...
  explicit RCTFlagsChecker(const char* label, bool checkZDC = false, bool treatLimitedAcceptanceAsBad = false)
  {
    init(std::string(label), checkZDC, treatLimitedAcceptanceAsBad);
  }
