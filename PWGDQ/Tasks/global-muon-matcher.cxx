...
struct GlobalMuonMatching {
  ...
  struct : ConfigurableGroup {
    Configurable<bool> cfgEnableMCHRefit{"cfgEnableMCHRefit", true, "Enable re-fitting of MCH tracks"};
...
/*
      std::cout << "MCH track parameters before realignment:" << std::endl
          << std::format("  {:+0.3f} {:+0.3f} {:+0.3f} {:+0.3f} {:+0.3f} ",
              mchTrackParIt->second.getParameters()(0),
              mchTrackParIt->second.getParameters()(1),
              mchTrackParIt->second.getParameters()(2),
              mchTrackParIt->second.getParameters()(3),
              mchTrackParIt->second.getParameters()(4)) << std::endl
          << std::format("  chi2={:+0.3f} Nclus={}", mchTrackParIt->second.getTrackChi2(), mchTrackParIt->second.getNClusters())
          << std::endl;
*/
...
/*
  ...
  void processMatchingCandidates(C const& collisions,
                                 ...
                                 bool useMixedMatchingCandidates)
  {
    if (configMchRealign.cfgEnableMCHRefit.value || configMchRealign.cfgEnableMCHRealign.value) {
